      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>
              A <strong className="text-white">SurebetFlow</strong> é uma plataforma de gestão de apostas esportivas que permite ao usuário organizar perfis, acompanhar resultados e controlar o desempenho financeiro em casas de apostas. Nosso compromisso é com a transparência e a segurança dos seus dados.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc list-inside text-gray-400">
              <li><span className="text-gray-300">Dados de cadastro:</span> nome, sobrenome, e-mail e data de nascimento fornecidos no momento do registro.</li>
              <li><span className="text-gray-300">Dados de uso:</span> apostas registradas, perfis criados, movimentações financeiras inseridas pelo próprio usuário.</li>
              <li><span className="text-gray-300">Dados técnicos:</span> endereço IP, tipo de dispositivo e navegador, coletados automaticamente para fins de segurança e diagnóstico.</li>
              <li><span className="text-gray-300">Foto de perfil:</span> imagem enviada voluntariamente pelo usuário.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-400 mb-3">Conforme a Lei Geral de Proteção de Dados (Lei nº 13.709/2018), você tem direito a:</p>
            <ul className="space-y-2 list-disc list-inside text-gray-400">
            ...
            <p className="text-gray-400 mt-3">Para exercer esses direitos, entre em contato pelo suporte da plataforma.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-white mb-3">7. Cookies e rastreamento</h2>
            <p className="text-gray-400">
          ...
          <section>
            <h2 className="text-base font-semibold text-white mb-3">8. Retenção de dados</h2>
            <p className="text-gray-400">
          ...
          <section>
            <h2 className="text-base font-semibold text-white mb-3">9. Alterações nesta política</h2>
            <p className="text-gray-400">
          ...
          <section>
            <h2 className="text-base font-semibold text-white mb-3">10. Contato</h2>
            <p className="text-gray-400">
