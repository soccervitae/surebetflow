      ...
      if (email) {
        try {
          ...
          await resend.emails.send({
            ...
            html: emailWrapper(`
              <p style="margin:0 0 6px;color:#0f172a;font-size:20px;font-weight:700;">Assinatura cancelada</p>
              <p style="margin:0 0 24px;color:#64748b;font-size:14px;line-height:1.7;">
                Sua assinatura do <strong style="color:#0f172a;">SurebetFlow</strong> foi cancelada.
              ...
              <a href="${APP_URL}/assinatura"
                 style="display:inline-block;padding:14px 28px;background:#1e3a8a;color:#fff;text-decoration:none;border-radius:12px;font-size:14px;font-weight:700;">
                Reativar assinatura
              </a>
        ...
        if (email) {
          try {
            ...
            await resend.emails.send({
              ...
              html: emailWrapper(`
                <p style="margin:0 0 6px;color:#0f172a;font-size:20px;font-weight:700;">⚠️ Problema com seu pagamento</p>
                <p style="margin:0 0 24px;color:#64748b;font-size:14px;line-height:1.7;">
                  Identificamos um problema ao processar o pagamento da sua assinatura do
                  <strong style="color:#0f172a;">SurebetFlow</strong>.
                  Para evitar a interrupção do seu acesso, atualize os dados do cartão o quanto antes.
                </p>
                <div style="background:#fef2f2;border-left:3px solid #ef4444;border-radius:0 8px 8px 0;padding:12px 16px;margin-bottom:28px;">
                ...
                <a href="${APP_URL}/assinatura"
                   style="display:inline-block;padding:14px 28px;background:#b91c1c;color:#fff;text-decoration:none;border-radius:12px;font-size:14px;font-weight:700;">
