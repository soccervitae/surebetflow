    ...
    <div className="min-h-screen bg-[var(--bg-base)] text-[var(--text-secondary)]">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">1. Aceitação dos termos</h2>
            <p className="text-[var(--text-secondary)]">
              Ao criar uma conta e utilizar a <strong className="text-[var(--text-primary)]">SurebetFlow</strong>, você declara que leu, compreendeu e concorda com estes Termos de Uso. Caso não concorde com alguma condição, não utilize a plataforma.
            </p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">2. Descrição do serviço</h2>
            <p className="text-[var(--text-secondary)]">
              A SurebetFlow é uma plataforma de <strong className="text-[var(--text-primary)]">gestão e organização de apostas esportivas</strong>. O serviço permite registrar perfis em casas de apostas, controlar movimentações financeiras, acompanhar resultados e visualizar estatísticas de desempenho. A plataforma é uma ferramenta de organização pessoal e não realiza apostas em nome do usuário.
            </p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">3. Elegibilidade</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">4. Cadastro e segurança da conta</h2>
            <ul className="space-y-2 list-disc list-inside text-[var(--text-secondary)]">
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">5. Uso aceitável</h2>
            <p className="text-[var(--text-secondary)] mb-3">É <strong className="text-[var(--text-primary)]">proibido</strong> utilizar a plataforma para:</p>
            <ul className="space-y-2 list-disc list-inside text-[var(--text-secondary)]">
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">6. Planos e pagamentos</h2>
            <ul className="space-y-2 list-disc list-inside text-[var(--text-secondary)]">
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">7. Responsabilidade e isenções</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">8. Propriedade intelectual</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">9. Suspensão e cancelamento</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">10. Modificações dos termos</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">11. Lei aplicável e foro</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section>
            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-3">12. Contato</h2>
            <p className="text-[var(--text-secondary)]">
        ...
        <div className="mt-12 pt-8 border-t border-[var(--border)] flex flex-wrap gap-4 text-xs text-[var(--text-muted)]">
          ...
          <Link href="/privacidade" className="hover:text-[var(--text-secondary)] transition-colors">Política de Privacidade</Link>
        </div>
      </div>
    </div>
  )
