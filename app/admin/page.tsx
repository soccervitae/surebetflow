              ...
              <tbody>
                ...
                {allProfiles.map((p, i) => (
                  <tr key={p.id} className={`border-b border-gray-800/50 hover:bg-gray-800/40 transition-colors ${i % 2 === 0 ? "" : "bg-gray-800/20"}`}>
                    ...
                    <td className={`px-3 py-3 text-right font-medium ${p.lucroRealizado >= 0 ? "text-green-400" : "text-red-400"}`}>
                      {formatCurrency(p.lucroRealizado)}
                    </td>
                    ...
                    <td className={`px-4 py-3 text-right font-semibold ${p.saldoTotal >= 0 ? "text-white" : "text-red-400"}`}>
                      {formatCurrency(p.saldoTotal)}
                    </td>
                  </tr>
                ))}
              </tbody>
